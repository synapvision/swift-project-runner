    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-background relative">
      ...
      <div className="w-full max-w-md relative animate-fade-in-up">
        <div className="glass-strong rounded-2xl p-8 md:p-10">
          ...
          <p className="text-sm text-muted-foreground text-center mb-8">Log in to your account and continue checking your content.</p>

          <Button variant="outline" className="w-full mb-4 h-11 active:scale-[0.97] transition-transform" onClick={handleGoogleLogin}>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="password" type={showPassword ? "text" : "password"} placeholder="Enter your password" className="pl-10 pr-10 h-11 bg-secondary/50" value={password} onChange={e => setPassword(e.target.value)} required />
